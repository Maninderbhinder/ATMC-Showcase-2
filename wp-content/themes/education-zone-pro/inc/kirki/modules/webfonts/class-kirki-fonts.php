...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'education-zone-pro' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'education-zone-pro' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'education-zone-pro' ),
			'200'       => esc_attr__( 'Light 200', 'education-zone-pro' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'education-zone-pro' ),
			'300'       => esc_attr__( 'Book 300', 'education-zone-pro' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'education-zone-pro' ),
			'400'       => esc_attr__( 'Normal 400', 'education-zone-pro' ),
			'regular'   => esc_attr__( 'Normal 400', 'education-zone-pro' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'education-zone-pro' ),
			'500'       => esc_attr__( 'Medium 500', 'education-zone-pro' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'education-zone-pro' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'education-zone-pro' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'education-zone-pro' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'education-zone-pro' ),
			'700'       => esc_attr__( 'Bold 700', 'education-zone-pro' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'education-zone-pro' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'education-zone-pro' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'education-zone-pro' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'education-zone-pro' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'education-zone-pro' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'education-zone-pro' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'education-zone-pro' ),
		);
	}
