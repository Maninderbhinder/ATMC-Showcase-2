...
jQuery( document ).ready(function($) {
    ...
    $(document).on( 'click', 'input[type="font"]', function(){
        ...
        if ( $(this).siblings( '.font-awesome-list' ).find( '.font-awesome-list-search' ).length < 1 ){
            var input = '<input type="text" class="font-awesome-list-search" value="" placeholder="search">';
            $(this).siblings( '.font-awesome-list:visible' ).prepend( input );
            $( '.font-awesome-list-search' ).attr( 'value', '' );
        }
    });
    ...
    $(document).on( 'click', '.font-group li', function(event){
        ...
        $(this).parent().siblings( '.font-awesome-list-search' ).remove( 'slow' );
    ...
    $(document).on( 'keyup', '.font-awesome-list-search', function(){
        var value = $(this).val();
        var matcher = new RegExp( value, 'gi' );
        $(this).siblings( '.font-group' ).children( 'li' ).show().not(function(){
