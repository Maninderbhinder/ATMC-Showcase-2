...
// register education_zone_pro_Facebook_Page_Widget widget.
function education_zone_pro_register_facebook_page_widget(){
    register_widget( 'education_zone_pro_Facebook_Page_Widget' );
}
add_action('widgets_init', 'education_zone_pro_register_facebook_page_widget');
 
 /**
 * Adds education_zone_pro_Facebook_Page_Widget widget.
 */
class education_zone_pro_Facebook_Page_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
			'education_zone_pro_facebook_page_widget', // Base ID
			__( 'RARA: Facebook Page Plugin', 'education-zone-pro' ), // Name
			array( 'description' => __( 'A widget that shows Facebook Page Box', 'education-zone-pro' ), ) // Args
		);
    }
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'page_url' ) ); ?>"><?php esc_html_e( 'Facebook Page URL', 'education-zone-pro' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Width', 'education-zone-pro' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height', 'education-zone-pro' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'container_width' ) ); ?>"><?php esc_html_e( 'Adapt to plugin container width', 'education-zone-pro' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_faces' ) ); ?>"><?php esc_html_e( "Show Friend's Faces", 'education-zone-pro' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'small_header' ) ); ?>"><?php esc_html_e( 'Use Small Header', 'education-zone-pro' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'hide_cover_photo' ) ); ?>"><?php esc_html_e( 'Hide Cover Photo', 'education-zone-pro' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_timeline_tab' ) ); ?>"><?php esc_html_e( 'Show Timeline Tab', 'education-zone-pro' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_event_tab' ) ); ?>"><?php esc_html_e( 'Show Event Tab', 'education-zone-pro' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_msg_tab' ) ); ?>"><?php esc_html_e( 'Show Message Tab', 'education-zone-pro' ); ?></label>
		</p>
		<?php 
	}
...
}  // class education_zone_pro_Facebook_Page_Widget 